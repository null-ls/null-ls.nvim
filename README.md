...
Activley developed fork of [jose-elias-alvarez/null-ls.nvim](https://github.com/jose-elias-alvarez/null-ls.nvim). Please see
[this issue](https://github.com/jose-elias-alvarez/null-ls.nvim/issues/1621) for details.
...
See
[this wiki page](https://github.com/null-ls/null-ls.nvim/wiki/Formatting-on-save).

### How do I stop Neovim from asking me which server I want to use for formatting?

See
[this wiki page](https://github.com/null-ls/null-ls.nvim/wiki/Avoiding-LSP-formatting-conflicts).
...
[This wiki page](https://github.com/null-ls/null-ls.nvim/wiki/Compatibility-with-other-plugins)
